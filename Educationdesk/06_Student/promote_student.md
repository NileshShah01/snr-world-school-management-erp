...
Route: /employee/promote-student
...
- /employee/load-student-with-result-for-promote?batch_id=
- /employee/complete-student-course-action

## JS Functions

- loadCourseSectionMain()
- loadBatchCourses()
- loadStudentWithResult()
- loadStudentWithResultWithSection()
- showActionPopUp()
- loadNextCourses()
- loadCourseSection()
- completeActionForCourse()

## Inline Events

- onchange=loadBatchCourses(this)
- onchange=loadStudentWithResult(this)
- onchange=loadStudentWithResultWithSection(this)
