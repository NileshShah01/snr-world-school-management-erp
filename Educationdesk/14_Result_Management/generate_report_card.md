...
Route: /employee/generate-report-card
...
|------|------|-------------|---------|
| generate_type | radio |  | course |
| generate_type | radio |  | partial |
| total_title_hide | checkbox |  |  |
| costomize_type_select | radio |  | default |
| costomize_type_select | radio |  | custom |
| title_manual_color | color |  | #000000 |
| sub_title_manual_color | color |  | #000000 |
...
- batch_id: 4 options
  ...
  -  = 
  -  = 
- parent_course_id: 0 options
- course_id: 0 options
- section: 0 options
- partial_batch_id: 4 options
  -  = 
  -  = 
  -  = 
  -  = 
- partial_parent_course_id: 0 options
- partial_course_id: 0 options
...
- font_size: 7 options
  ...
  -  = 
  -  = 
- heading_font: 20 options
- heading_font_size: 95 options
- heading_font_line_height: 100 options
- subtitle_font: 17 options
- subtitle_font_size: 95 options
...
- /employee/generate-report-card-ajax
...
- onchange=loadChildCourse(this,'partial');loadStudentsForCourses(this);
...
Grid: col-md-3, col-md-12, col-md-4, col-md-6
