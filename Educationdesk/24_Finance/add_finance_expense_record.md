...
Route: /employee/add-finance-expense-record
...
### Form 1
- Action: add-finance-expense-record
- Method: POST
...
| record_date | text | Select Date of Expense |  |
| payee_name | text | Select Payee Name |  |
| amount_paid_enabled | checkbox |  |  |
| paid_amount | text | Enter Paid Amount |  |
| payment_date | text | Select Date of Payment |  |

#### Selects
- finance_head_id: 1 options
  -  = 
- employee_id: 16 options
- account_id: 2 options
  -  = 
  -  = 
- account_id: 0 options
...
- onclick=downloadExpensePdf(1197156)
- onclick=downloadExpensePdf(1197131)
- onclick=downloadExpensePdf(1197128)
- onclick=downloadExpensePdf(1197092)
