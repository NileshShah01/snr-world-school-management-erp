# Manage Transport Fee Type [Search/Add/Edit]

Route: /employee/add-transport-fee-type
...
- /employee/get-transport-fee-type-for-batch?batch_id=
- /employee/add-transport-fee-type
- /employee/get-fee_type-for-transport?course_fee_type_id=
