...
Route: /employee/employee-leave-type
...
| edit_leave_type_id | hidden |  | 0 |
| time_circle | radio |  | Monthly |
| time_circle | radio |  | Yearly |
| time_circle | radio |  | Session |
| time_circle | radio |  | On Occassion |
| leave_type | radio |  | Paid |
| leave_type | radio |  | Unpaid |
| default_count | text | Enter Default Leave | 0 |
| enabled | checkbox |  |  |
