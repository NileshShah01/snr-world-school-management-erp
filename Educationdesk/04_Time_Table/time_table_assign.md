# View Time Table Teacher Allotment

Route: /employee/time-table-assign
...
- /employee/get-assign-time-table-for-course?course_id=
- /employee/add-time-table-for-assign-course
- /employee/check-employee-time-table-availability
...
- onchange=loadAssignTimeTable('#course_semester');
- onchange=loadAssignTimeTable(this);
