...
Route: /employee/add-product-rate-plan
...
| rate_plan_id | hidden |  | 0 |
| rate_plan_code | text |  |  |
| start_date | text |  |  |
| end_date | text |  |  |
| enabled | checkbox |  |  |
| active_rateplan | checkbox |  |  |
| price_with_tax | checkbox |  |  |

#### Selects
- applicable_for: 2 options
  -  = 
  -  = 
...
### Form 2
- Action: product-tax-rule
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| edit_product_tax_rule_id | hidden |  | 0 |
| action | hidden |  | edit |
...
- onchange=loadProductCategory(this);
