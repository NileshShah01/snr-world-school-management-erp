...
Route: /employee/search-employee
...
- getUserNameAvailabilitySubmit()

## Inline Events

- onclick=editFun(2874)
- onclick=editFun(3138)
- onclick=editFun(4179)
- onclick=editFun(4180)
- onclick=editFun(4300)
- onclick=editFun(4301)
- onclick=editFun(4302)
- onclick=editFun(4303)
- onclick=editFun(4304)
- onclick=editFun(4305)
- onclick=editFun(4760)
- onclick=editFun(4761)
- onclick=editFun(4762)
- onclick=editFun(4763)
- onclick=editFun(4764)
- onclick=editFun(6023)
