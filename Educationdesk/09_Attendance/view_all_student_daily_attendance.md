# Download/View Student Attendance

Route: /employee/view-all-student-daily-attendance
...
### Form 1
- Action: view-all-student-daily-attendance
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| start_date | text | Select Attendance Date |  |
...
- /employee/add-student-daily-attendance
- /employee/get-student-for-daily-attendance?course_id=
