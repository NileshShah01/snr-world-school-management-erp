...
|------|------|-------------|---------|
| payment_release_date | text | Payment Release Date |  |
| salary_head_ids | hidden |  |  |

#### Selects
- employee_id: 15 options
- salary_month: 74 options
- payment_mode: 3 options
  -  = 
  -  = 
  -  = 
- account_id: 2 options
  -  = 
  -  = 
- finance_head_id: 1 options
  -  = 
...
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| extra_head_amount | text | Enter Amount | 0 |

#### Selects
- extra_head_id: 0 options
...
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| extra_head_amount_salary | text | Enter Amount | 0 |
| salary_loan_id_hidden | hidden |  | 0 |
| salary_loan_id_hidden | hidden |  | 0 |
| salary_loan_disbursed_amount_hidden | hidden |  | 0 |
| salary_loan_emi_amount_hidden | hidden |  | 0 |
| salary_loan_paid_amount_hidden | hidden |  | 0 |

#### Selects
- salary_loan_id: 0 options
- extra_head_id_salary: 0 options

## AJAX Endpoints

- salary-loan-transaction-details-ajax?salary_loan_id=
...
- onchange=salaryLoanCalculate()
- onchange=salaryLoanCalculate();
- onclick=addExtraLoanSubmit();
- onclick=removeExtraHead('+headId+')
