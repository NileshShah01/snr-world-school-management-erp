# Manage Vehicle Stoppage

Route: /employee/manage-stoppage
...
### Form 1
- Action: manage-stoppage
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| stop_name | text | Enter Stop Name |  |
| stoppage_id | hidden |  | 0 |
| latitude | hidden |  |  |
| longitude | hidden |  |  |
| enabled | checkbox |  |  |
