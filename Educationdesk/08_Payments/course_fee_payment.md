# Student Class Fee Payment

Route: /employee/course-fee-payment
...
| discount_pending_amount | hidden |  |  |
...
|------|------|-------------|---------|
| student_id | hidden |  |  |
| delete_bulk_payment_ids | hidden |  |  |
...
- /employee/get-student-for-active-batch-course?parent_course_id=
- /employee/get-fee-payment-for-student?parent_course_id=
- add-discount-student-fee-payment
- delete-student-fee-payment
- delete-student-bulk-fee-payment
...
- loadFeePaymentForStudentCourse()
- editDiscount()
- addDiscountSubmit()
- removePayment()
- removePaymentBulk()
- removeConfirmation()
- removeBulkConfirmation()
- loadCourseSection()
- getSectionString()
...
- onchange=loadCourseSection();loadStudentForCourse(this);
- onchange=loadStudentForCourse('#course_main_x');
- onchange=loadFeePaymentForStudentCourse(this);
- onclick=addDiscountSubmit();
- onclick=loadFeePaymentForStudentCourse();
- onclick=removeConfirmation();
- onclick=removeBulkConfirmation();
