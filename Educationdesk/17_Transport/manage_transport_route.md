# Manage Transport Route

Route: /employee/manage-transport-route
...
| route_id | hidden |  | 0 |
| route_from | text | Enter Route From |  |
| route_to | text | Enter Route To |  |
| enabled | checkbox |  |  |

#### Selects
- vehicle_id: 0 options
- driver_id: 0 options
- assigned_teacher_id: 16 options
