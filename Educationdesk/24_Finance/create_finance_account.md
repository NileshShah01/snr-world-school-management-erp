...
Route: /employee/create-finance-account
...
| finance_account_id | hidden |  | 0 |
| balance | text | Enter Opening Balance | 0 |
| enabled | checkbox |  |  |

#### Selects
- account_type: 3 options
  -  = 
  -  = 
  -  = 
...
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| edit_finance_account_id | hidden |  | 0 |
