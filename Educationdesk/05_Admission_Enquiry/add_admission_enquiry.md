...
Route: /employee/add-admission-enquiry
...
| student_name | text | Enter Student Name |  |
| student_dob | text | Select DOB |  |
| caste | text | Enter Caste |  |
...
| father_qualification | text | Enter Father Qualification |  |
| mother_qualification | text | Enter Mother Qualification |  |
| previous_school | text | Enter Previous School |  |
| previous_class | text | Enter Previous Class |  |
| payment_enabled | radio |  | No |
| payment_enabled | radio |  | Yes |
| additinal_fee_add_count | hidden |  | 1 |
| follow_up_date | text | Enter FollowUp Date |  |
| follow_up_time | text | Time |  |

#### Selects
- gender: 2 options
  -  = 
  -  = 
- student_religion: 5 options
  -  = 
  -  = 
  -  = 
  -  = 
...
- category: 6 options
  ...
  -  = 
  -  = 
- admission_session: 4 options
  -  = 
  -  = 
  -  = 
  -  = 
- admission_class: 0 options
- assigned_to_id: 15 options
- primary_source_id: 1 options
  -  = 
...
Grid: col-md-3, col-md-12, col-md-6, col-md-2, col-md-1
