# Assign Stoppage To Route

Route: /employee/assign-student-to-route
...
### Form 1
- Action: assign-student-to-route
- Method: GET
...
|------|------|-------------|---------|
| route_id | hidden |  |  |
| stoppage_mapping_id_edit | hidden |  |  |
...
- onchange=loadRouteStoppageList(this)
- onclick=deleteStudentMappingCnfrm();
