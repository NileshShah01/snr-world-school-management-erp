...
Route: /employee/dashboard-configuration
...
| dashboard_detail_id | hidden |  | 0 |
| enabled | checkbox |  |  |
| default_item_id | checkbox |  | 1 |

#### Selects
- designation_id: 2 options
  -  = 
  -  = 
- employee_id: 16 options
- dashboard_item_id: 5 options
  -  = 
  -  = 
  -  = 
  -  = 
