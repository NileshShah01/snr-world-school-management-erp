...
| batch_id | hidden |  | 0 |
| batch_code | text | Enter Batch Code |  |
| start_date | text | Enter Start Date |  |
| end_date | text | Enter End Date |  |
| enabled | checkbox |  |  |
| current_session | checkbox |  |  |

#### Selects
- timetable_session: 4 options
  -  = 
  -  = 
  -  = 
  -  = 
