# Manage Class Fee Type [Search/Add/Edit]

Route: /employee/add-course-fee-type
...
- /employee/get-course-fee-type-for-batch?batch_id=
- /employee/add-course-fee-type
- /employee/get-fee_type-for-course?course_fee_type_id=
