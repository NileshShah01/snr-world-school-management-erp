# Employee Leave Assign

Route: /employee/employee-leave-assign
...
- /employee/get-employee-leave-assign?employee_id=
- /employee/add-employee-leave-assign

## JS Functions

- loadEmployeeLeaveAssign()
- addEmployeeLeaveAssign()

## Inline Events

- onchange=loadEmployeeLeaveAssign(this);
