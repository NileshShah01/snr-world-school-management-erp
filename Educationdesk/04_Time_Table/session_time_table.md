# Class Time Table Details For Session

Route: /employee/session-time-table
...
- /employee/get-employee-for-course
- /employee/get-time-table-for-session?batch_id=
- /employee/get-time-table-pdf-for-session?batch_id=

## JS Functions

- loadParentCourse()
- loadEmployeeForCourse()
- loadSessionTimetable()
- downloadPDF()

## Inline Events

- onchange=loadSessionTimetable(this);
- onchange=loadSessionTimetable('#day_name');
