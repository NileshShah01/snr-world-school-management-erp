...
|------|------|-------------|---------|
| action | hidden |  | search |
| search_type | radio |  | mobile |
| search_type | radio |  | name |
| search_text | text | Student Id / Name / Phone |  |
| student_id_search | checkbox |  | 1 |
...
- /employee/search-student-for-add-order
- /employee/add-product-for-add-order
- /employee/get-product-for-add-order
- get-child-product-category?parent_category_id=
- get-product-for-category?category_id=
- get-product-details-for-add-order?product_id=
...
- onclick=stepProcess(2)
- onchange=loadChildCategory(this);
- onchange=loadProductForCategory(this)
- onchange=loadProductDetail(this)
...
Grid: col-md-3, col-md-12, col-md-6, col-md-9
