...
Route: /employee/student-communication
...
### Form 1
- Action: student-communication
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| student_type_select | radio |  | all |
| student_type_select | radio |  | batch |
| student_type_select | radio |  | course |
| student_type_select | radio |  | partial |
| communication_type_select | radio |  | email |
| communication_type_select | radio |  | sms |
| subject | text |  |  |
| cc_email | text |  |  |
| bcc_email | text |  |  |
|  | checkbox |  |  |
...
- route_id: 0 options
- email_template: 0 options
- sms_template: 48 options

## AJAX Endpoints

- /employee/get-parent-course?course_batch_id=
- /employee/get-student-for-course?course_id=
- /employee/load-email-template?email_template_id=
- /employee/load-sms-template?sms_template_id=
...
- countChar()
- isDoubleByte()
- loadRouteStoppageList()

## Inline Events

- onchange=loadBatchCourses(this)
- onchange=loadStudentsForCourses(this)
- onchange=loadRouteStoppageList(this)
- onchange=loadEmailTemplate(this);
- onchange=loadSmsTemplate(this);
- onclick=javascript:checkboxClickHandler()
- onchange=javascript:languageChangeHandler()
