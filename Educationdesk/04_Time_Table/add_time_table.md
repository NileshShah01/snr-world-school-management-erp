# Manage Time Table [Search/Add/Edit]

Route: /employee/add-time-table
...
- /employee/get-subject-for-course?course_id=
- /employee/get-time-table-for-course?course_id=
- /employee/add-time-table-for-course
- /employee/get-time-table-pdf-for-course?course_id=
...
- loadParentCourse()
- loadChildCourse()
- loadSubjectForCourse()
- loadTimeTable()
- addTimeTableForCourse()
- showPeriodTable()
- showEditTable()
- showPreviewTable()
- downloadPDF()
...
- onchange=loadTimeTable('#course_semester');
- onchange=loadTimeTable(this);
