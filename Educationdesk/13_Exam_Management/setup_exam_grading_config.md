...
Route: /employee/setup-exam-grading-config
...
|------|------|-------------|---------|
| grade_name | text | Enter Grade Name |  |
| exam_grade_id | hidden |  | 0 |
| start_percentage | text | Enter From Percentage example : 50.10 |  |
| end_percentage | text | Enter To Percentage example : 50.10 |  |
| enabled | checkbox |  |  |

#### Selects
- index_seq: 20 options
