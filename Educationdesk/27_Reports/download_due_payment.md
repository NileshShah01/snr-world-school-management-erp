# Download All Due Payment Excel

Route: /employee/download-due-payment
...
- /employee/get-student-pay-remarks?student_id=
- update-student-pay-remarks
...
- loadCourseSection()
- payRemarksConfirm()
- getStudentPayRemarks()
- submitStudentPayRemarks()
