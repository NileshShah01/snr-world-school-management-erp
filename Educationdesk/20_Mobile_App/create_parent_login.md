# Search Student Parent Login

Route: /employee/create-parent-login
...
### Form 1
- Action: parent-login-manage
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| student_search_type | radio |  | phone |
| student_search_type | radio |  | course |
| search_text | text | Enter Registered Phone |  |
...
- student_id: 0 options

### Form 2
- Action: create-parent-login
- Method: POST
