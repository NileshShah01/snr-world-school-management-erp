...
Route: /employee/create-study-document
...
### Form 1
- Action: create-study-document
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| study_document_id | hidden |  | 0 |
| title | text | Enter Title |  |
| document_type | radio |  | TEXT |
| document_type | radio |  | IMAGE_PDF |
| document_type | radio |  | YOUTUBE_VIDEO |
| document_link | text | Enter Youtube Link |  |
...
|------|------|-------------|---------|
| privilege_id | hidden |  |  |
| privilege_id_1 | hidden |  |  |
| privilege_id_2 | hidden |  |  |
| action | hidden |  | load |
...
- /employee/get-subjects-course-wise?course_id=
- upload-homework-img-data
...
- onchange=loadCourseSubject(this);
