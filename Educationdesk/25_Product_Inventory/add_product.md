...
| product_id | hidden |  | 0 |
| product_code | text | Enter Product Code |  |
| product_code_2 | text | Enter Product Code 2 |  |
| mrp | text | Enter Product MRP |  |
| product_rate | text | Enter Product Rate |  |
| box_quantity | text | Enter No of Peice |  |
| brand_name | text | Enter Brand Name |  |
| barcode | text | Enter Barcode No |  |
| enabled | checkbox |  |  |

#### Selects
- parent_category_id: 1 options
  -  = 
- product_category_id: 0 options
...
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| edit_product_id | hidden |  | 0 |
| action | hidden |  | edit |

### Form 3
- Action: /employee/homework-document-upload
- Method: POST
...
- /employee/get-child-product-category?parent_category_id=
- product-additional-fields-mapping-ajax?product_category_id=
- upload-base64-img-data
...
- onchange=loadChildCategory(this);
- onclick=uploadDocumentPopUp(1)
- onclick=uploadDocumentForm()
- onclick=removeDoc('+displayIndex+')
...
- /static/js/resizeimage/binaryajax.js
- /static/js/resizeimage/exif.js
- /static/js/resizeimage/canvasResize.js
