# Student NonSubject Result Management

Route: /employee/manage-nonsubject-result
...
- /employee/get-student-nonsubject-result?course_id=
- /employee/add-student-nonsubject-result-marks
...
- loadParentCourse()
- loadChildCourse()
- loadNonSubjectResultForStudent()
- minMax()
- checkLetter()
...
- onchange=loadNonSubjectResultForStudent(this);
