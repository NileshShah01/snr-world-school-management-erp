...
Route: /employee/manage-salary-structure
...
### Form 1
- Action: manage-salary-structure
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| name | text | Enter Template Name |  |
...
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| edit_salary_structure_id | hidden |  | 0 |

## Data Table Columns

1. Structure Template Name
2. Fixed Salary Head
3. Create Date
4. Enabled
