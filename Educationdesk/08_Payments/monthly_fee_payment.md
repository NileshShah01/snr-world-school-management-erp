...
Route: /employee/monthly-fee-payment
...
- /employee/get-fee-payment-for-month?parent_course_id=
...
- onchange=loadStudentForCourse(this);
- onchange=loadFeePaymentForMonth();
