# Elective Subject Mapping With Student

Route: /employee/elective-subject-mapping
...
- /employee/get-student-elective-subject-mapping?course_id=
- /employee/add-elective-subject-mapping-for-course

## JS Functions

- loadParentCourse()
- loadChildCourse()
- loadStudentForElectiveMapping()
- addElectiveSubjectMappingForCourse()

## Inline Events

- onchange=loadParentCourse(this);
- onchange=loadChildCourse(this);
- onchange=loadStudentForElectiveMapping(this);
