...
Route: /employee/manage-vehicle-detail
...
| vehicle_id | hidden |  | 0 |
| vehicle_number | text | Enter Vehicle Number |  |
| vehicle_model | text | Enter Vehicle Model |  |
| device_id | text | Enter GPS Device Id |  |
| seat_capacity | text | Enter Seat Capacity | 0 |
| enabled | checkbox |  |  |
