# Student WhatsApp Communication

Route: /employee/student-whatsapp-communication
...
### Form 1
- Action: student-whatsapp-communication
- Method: POST
...
| communication_type_select | radio |  | whatsapp |
...
- /employee/load-whatsapp-template?template_id=
- test-student-whatsapp-communication
...
- onchange=loadWhatsAppTemplate(this);
