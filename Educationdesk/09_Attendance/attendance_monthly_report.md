...
Route: /employee/attendance-monthly-report
...
### Form 1
- Action: attendance-monthly-report
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| attendance_start_date | text | Enter Start Date |  |
| attendance_end_date | text | Enter End Date |  |
...
- /employee/get-student-for-course-batch-section?course_id=
- send-attendance-alert-report
