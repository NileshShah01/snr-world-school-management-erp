# Class Fee Late Payment Rule

Route: /employee/late-fee-fine-rule
...
| late_fee_rule_id | hidden |  | 0 |
| late_fee_amount | text | Late Fee Amount |  |
| grace_period_after_due_date | text | Late Fee Charge After Due Day | 0 |
| current_month_only | checkbox |  |  |
| enabled | checkbox |  |  |
...
- batch_id: 4 options
  ...
  -  = 
  -  = 
- applicable_fee_type_id: 0 options
- late_fee_type_id: 0 options
...
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| edit_late_fee_rule_id | hidden |  | 0 |
| action | hidden |  | edit |

## AJAX Endpoints

- /employee/get-course-fee-type-option-for-batch?batch_id=
...
3. Session
4. Late Fee Amount
5. Apply after due in days
6. Applicable Fee Types Name
7. Late Fee Type Name
8. Enabled
...
- onchange=loadCourseFeeType(this);
- onclick=editFun(25)
