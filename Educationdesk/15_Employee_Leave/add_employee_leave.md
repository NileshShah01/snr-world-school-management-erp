# Add/Approve Employee Leave

Route: /employee/add-employee-leave
...
### Form 1
- Action: add-employee-leave
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| start_date | text | Enter From Date |  |
| end_date | text | Enter To Date |  |

#### Selects
- employee_id: 15 options
- leave_type: 0 options
...
- /employee/get-employee-leave-type?employee_id=
- /employee/get-employee-assigned-leave-balance-history?employee_id=
- approve-employee-leave-confirmation

## JS Functions

- loadEmployeeLeaveType()
- loadEmployeeLeaveAssigned()
- approveLeaveStatus()
- approveLeave()

## Inline Events

- onchange=loadEmployeeLeaveType(this);loadEmployeeLeaveAssigned(this);
- onclick=loadEmployeeLeaveAssigned('#employee_id')
