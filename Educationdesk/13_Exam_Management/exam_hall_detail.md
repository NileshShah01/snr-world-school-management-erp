...
Route: /employee/exam-hall-detail
...
| exam_hall_id | hidden |  | 0 |
| sitting_capacity | text | Enter Sitting Capacity |  |
| building_name | text | Enter Building Name |  |
| enabled | checkbox |  |  |
