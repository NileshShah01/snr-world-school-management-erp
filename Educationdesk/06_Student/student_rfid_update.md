# Update Student Bulk Data

Route: /employee/student-rfid-update
...
- /employee/student-rfid-update-ajax?parent_course_id=
- /employee/student-rfid-update-submit
...
- onchange=loadStudentForCourse('#course_main');
