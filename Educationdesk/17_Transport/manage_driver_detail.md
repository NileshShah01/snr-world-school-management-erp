...
Route: /employee/manage-driver-detail
...
| driver_id | hidden |  | 0 |
| driving_license_no | text | Enter Driving Licence |  |
| phone | text | Enter Phone |  |
| email | text | Enter Email |  |
| age | text | Enter Age | 0 |
