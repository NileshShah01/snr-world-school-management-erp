...
Route: /employee/add-course-details
...
- /employee/show-course-sesssions?batch_id=
- /employee/add-course-sesssions
...
- validateInternalExamCount()

## Inline Events

- onchange=loadBatchCourses(this)
- onchange=loadCourseSessions(this)
