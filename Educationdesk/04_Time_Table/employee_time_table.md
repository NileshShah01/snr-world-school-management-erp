# Employee Time Table Details For Class

Route: /employee/employee-time-table
...
- /employee/get-time-table-for-employee?employee_id=
...
- onchange=loadEmployeeForCourse(this);
- onchange=loadEmployeeTimeTable(this);
- onchange=loadEmployeeTimeTable('#employee');
