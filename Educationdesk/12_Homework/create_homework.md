...
Route: /employee/create-homework
...
|------|------|-------------|---------|
| homework_id | hidden |  | 0 |
| title | text | Enter Title |  |
| homework_date | text | Date of Homework |  |
| submission_date | text | Date of Submission |  |
| is_published | checkbox |  |  |
| is_submit_available | checkbox |  |  |
