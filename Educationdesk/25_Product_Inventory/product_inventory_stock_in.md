# Product Inventory In

Route: /employee/product-inventory-stock-in
...
### Form 1
- Action: product-inventory-stock-in
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| product_quantity | text | Enter Stock Quanlity |  |
| order_id | text | Enter Order Id |  |

#### Selects
- product_id: 0 options
- transaction_mode: 2 options
  -  = 
  -  = 
