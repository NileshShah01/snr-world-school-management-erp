...
Route: /employee/apply-self-employee-leave
...
### Form 1
- Action: apply-self-employee-leave
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| employee_id | hidden |  | 2874 |
...
- /employee/get-employee-assigned-self-leave-balance-history?employee_id=
