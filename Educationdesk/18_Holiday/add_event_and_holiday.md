...
Route: /employee/add-event-and-holiday
...
### Form 1
- Action: add-event-and-holiday
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| entry_type | radio |  | Event |
| entry_type | radio |  | Holiday |
| event_name | text | Enter Event Name |  |
| event_start_date | text | Enter Start Date |  |
| event_start_time | text | Time |  |
| event_end_date | text | Enter End Date |  |
| event_end_time | text | Time |  |
| holiday_type | radio |  | Recurring |
| holiday_type | radio |  | Specific |
| holiday_name | text | Enter Event Name |  |
| notification_enabled | radio |  | Yes |
| notification_enabled | radio |  | No |
| holiday_start_date | text | Enter Start Date |  |
| holiday_end_date | text | Enter End Date |  |

#### Selects
- recurring_day: 7 options
  -  = 
  -  = 
  -  = 
  -  = 
