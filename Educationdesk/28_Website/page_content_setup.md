# Publish/Manage Website Content

Route: /employee/page-content-setup
...
- parent_priv: 9 options
  ...
  -  = 
  -  = 
- sub_menu_1: 0 options
- sub_menu_2: 0 options
...
#### Selects
- file_category: 5 options
  -  = 
  -  = 
  -  = 
  -  = 
  -  = 
- file_display_index: 15 options
...
- /employee/website-link-option-ajax?priv_id=
- /employee/page-content-setup-ajax?privilege_id=
...
- onchange=loadSubmenu1(this);
- onchange=loadSubmenu2(this);
- onchange=loadContent(this);
