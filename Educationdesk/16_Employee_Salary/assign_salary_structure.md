# Assign Employee Salary Structure

Route: /employee/assign-salary-structure
...
### Form 1
- Action: assign-salary-structure
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| salary_assigned_id | hidden |  | 0 |
| effective_from | text | Month Effective From |  |

#### Selects
- employee_id: 15 options
- salary_structure_id: 1 options
  -  = 
...
| salary_structure_id | hidden |  | 0 |
| salary_assigned_id | hidden |  | 0 |

## Data Table Columns

1. Salary Template Name
2. Fixed Salary
3. Create Date
4. Effective From
5. Remarks
