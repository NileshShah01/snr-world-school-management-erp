# Bulk Add Extra Payment to Existing Fee

Route: /employee/bulk-extra-fee
...
- loadCourseFeeType()
- onCourseFeeTypeChange()
- loadCourseFeeForBatch()

## Inline Events

- onchange=loadBatchCourses(this)
- onchange=loadCourseFeeForBatch(this)
