...
Route: /employee/update-report-card-remarks
...
### Form 1
- Action: update-report-card-remarks
- Method: POST
...
- /employee/get-student-report-card-remarks?batch_id=
- /employee/update-report-card-remarks
...
- onclick=loadExamResultForStudent()
