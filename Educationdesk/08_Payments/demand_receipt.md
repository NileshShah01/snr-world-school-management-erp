...
- month_name: 0 options
- till_month_name: 0 options

## AJAX Endpoints

- /employee/get-parent-course?course_batch_id=
- /employee/get-student-for-batch-course?parent_course_id=
- /employee/get-month-for-batch-course?parent_course_id=
- /employee/get-demand-receipt-for-month?r_download=
...
- getSectionString()
- loadFeeMonthForCourse()
- loadFeePaymentForMonth()
- tillMonthSelect()
- loadCourseSection()
...
- onchange=loadFeeMonthForCourse(this);
- onchange=loadStudentForCourse();
- onchange=tillMonthSelect(this)
- onclick=loadFeePaymentForMonth(1);
