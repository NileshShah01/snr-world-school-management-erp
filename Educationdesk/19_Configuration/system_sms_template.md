...
Route: /employee/system-sms-template
...
### Form 1
- Action: system-sms-template
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| sms_template_id | hidden |  | 0 |
| dlt_template_id | text | Enter DLT Template Id |  |
| enabled | checkbox |  |  |
...
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| edit_sms_template_key | hidden |  | 0 |
| edit_mode | hidden |  | 1 |
