# Print Exam Attendance Sheet

Route: /employee/exam-attendance-card
...
- section: 0 options
- exam_hall_plan: 5 options
  -  = 
  -  = 
  -  = 
  -  = 
  -  = 
- exam_hall_detail: 1 options
  -  = 
- sort_by: 2 options
  -  = 
  -  = 
- first_page_row: 15 options
- other_page_row: 16 options
...
- /employee/exam-attendance-card-print?batch_id=
...
- loadChildCourse()
- loadExamForCourse()
- publishExamScheduleForCourse()
- loadImageForPDFDownload()
- dowanLoadExamAttendance()
- imgToBase64()
- loadCourseSection()
- getSectionString()
...
- onchange=publishExamScheduleForCourse(this);
