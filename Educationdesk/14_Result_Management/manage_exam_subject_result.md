# Student Exam Subject Result Management

Route: /employee/manage-exam-subject-result
...
- section: 0 options
- exam_detail: 0 options
- sort_by: 2 options
  -  = 
  -  = 
- subject_detail: 0 options
...
- /employee/get-exam-option-for-course?course_id=
- /employee/get-subjcet-option-for-exam?course_id=
- /employee/get-student-exam-result-subject-wise?course_id=
- /employee/add-student-exam-subject-result-marks
...
- loadChildCourse()
- loadExamForCourse()
- loadSubjectsBasedOnExam()
- loadExamSubjectResultForStudent()
- minMax()
- checkLetter()
- addResultMarksForExam()

## Inline Events

- onchange=loadParentCourse(this);
- onchange=loadChildCourse(this);
- onchange=loadExamForCourse(this);
- onchange=clearExamSelection()
- onchange=loadSubjectsBasedOnExam(this);
- onchange=loadExamSubjectResultForStudent(this);
