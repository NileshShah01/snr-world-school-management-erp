...
Route: /employee/add-finance-income-record
...
### Form 1
- Action: add-finance-income-record
- Method: POST
...
| record_date | text | Select Date of Income |  |

#### Selects
- finance_head_id: 14 options
- account_id: 2 options
  -  = 
  -  = 
- student_id: 345 options
