# View Student Exam Attendance

Route: /employee/view-student-exam-attendance
...
- /employee/get-student-exam-attendance?course_id=
...
- loadChildCourse()
- loadExamForCourse()
- loadExamAttendanceForStudent()
- downloadAttendanceForExam()
...
- onchange=loadExamAttendanceForStudent(this);
