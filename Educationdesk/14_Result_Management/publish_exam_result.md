...
Route: /employee/publish-exam-result
...
- /employee/get-student-exam-result-for-publish?course_id=
- /employee/publish-exam-result-for-exam?course_id=
...
- loadChildCourse()
- loadExamForCourse()
- loadExamResultForStudent()
- downloadResultsForExam()
- publishExamResultForCourse()
...
- onchange=loadExamResultForStudent(this);
