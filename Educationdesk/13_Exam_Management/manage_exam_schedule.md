# Manage Exam Schedule [Search/Add/Edit]

Route: /employee/manage-exam-schedule
...
- /employee/get-exam-schedule-for-course-exam?course_id=
- /employee/add-exam-schedule-for-course-exam
...
- loadChildCourse()
- loadExamForCourse()
- loadExamScheduleForCourse()
- addExamScheduleForCourse()
- editExamScheduleShow()
- dowanLoadExamSchedule()
...
- onchange=loadExamScheduleForCourse(this);
