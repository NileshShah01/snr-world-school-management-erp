...
Route: /employee/account-balance-transfer
...
### Form 1
- Action: account-balance-transfer
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| amount | text | Enter Income Amount |  |
| record_date | text | Select Date of Transaction |  |

#### Selects
- from_account_id: 2 options
  -  = 
  -  = 
- to_account_id: 0 options
