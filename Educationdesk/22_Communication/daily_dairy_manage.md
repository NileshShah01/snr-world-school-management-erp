...
Route: /employee/daily-dairy-manage
...
### Form 1
- Action: daily-dairy-manage
- Method: POST

#### Input Fields
| Name | Type | Placeholder | Default |
|------|------|-------------|---------|
| daily_diary_id | hidden |  | 0 |
| action | hidden |  | add |
| daily_diary_date | text | Date of Diary |  |
...
- daily-dairy-manage-ajax?course_id=
